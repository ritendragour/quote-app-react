      ...
      <div className="container marPad ">
        ...
        <div className="container marPad ">
          ...
          <div className="container marPad">
            ...
            <b>API : https://newsapi.org/v2/everything?q= "TOPIC"&from=2023-03-11&sortBy= publishedAt&apiKey=YOUR_KEY</b>
            <p className="text-danger float-end">NOTE : Using Only LocalHost</p><br /><br />
            <b>API : https://newsdata.io/api/1/ news?apikey= YOUR_KEY&q="TOPIC"</b>
