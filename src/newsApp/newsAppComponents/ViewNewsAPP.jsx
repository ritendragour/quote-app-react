...
const ViewNewsAPP = ({ news }) => {
  ...
  return (
    <div div className='uiNews MobilePadding'>
      ...
      <div className="col-xl-2  bg-light card mt-3 wordLimitside HideShow_side">
        <span className='w-100'>

        <i className='float-end'><MdOutlineCancel/></i>
        </span>
            <h3 className='text-center'> <u>Top News 100 +</u></h3>
        <img alt="IMG" width="80%" height="20%" src="https://images.pexels.com/photos/159652/table-food-book-newspaper-159652.jpeg?auto=compress&cs=tinysrgb&w=600" />
